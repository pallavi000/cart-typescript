  ...
  return (
    <div className='flex justify-between items-center p-4 shadow-sm  bg-white w-full sticky top-0'>
        <div className='flex items-center gap-8 font-medium text-lg'>
            <Link to="/home" className='hover:text-gray-600 cursor-pointer'>Home</Link>
        ...
        <div className='absolute -bottom-1 -right-1 bg-red-600 px-1.5 py-0.5 text-xs text-white rounded-full'>{totalQuantity}</div>
        </div>
    </div>
  )
}
